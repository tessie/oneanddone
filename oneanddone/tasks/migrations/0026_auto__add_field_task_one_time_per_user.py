...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.one_time_per_user'
        db.add_column('tasks_task', 'one_time_per_user',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.one_time_per_user'
        db.delete_column('tasks_task', 'one_time_per_user')
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'one_time_per_user': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
