...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.managed_task'
        db.delete_column('tasks_task', 'managed_task')

        # Adding field 'Task.is_managed_task'
        db.add_column('tasks_task', 'is_managed_task',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Task.managed_task'
        db.add_column('tasks_task', 'managed_task',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Task.is_managed_task'
        db.delete_column('tasks_task', 'is_managed_task')
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'is_managed_task': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
